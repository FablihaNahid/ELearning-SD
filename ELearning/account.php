...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="stucourses.php"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;Courses</a></li></ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">ELearning</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">ELearning Infotech</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Ahsanullah University of Science & Technology</h4>
		
		<h4 style="font-family:'typo' ">Dhaka, Bangladesh </h4></div></div>
		</p>
      </div>
